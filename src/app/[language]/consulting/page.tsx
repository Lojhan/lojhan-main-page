...
function ExpertiseSection({
  ...
  return (
    <>
      <span className="hidden" id="consulting-services" />
      <Container>
        <SectionIntro
...
function ContactSuccessStoriesSection() {
  return (
    <>
      <span className="hidden" id="client-success-stories" />
      <Container>
        <SectionIntro
        ...
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 py-12 md:grid-cols-2">
            ...
            <div className="flex-col">
              <CardContent className="flex-1/3">
                <p className="text-sm text-muted-foreground">
                  &quot;We were experiencing significant performance issues
                  during peak traffic. The architecture review and optimization
                  recommendations reduced our server load by 70% and cut
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                &quot;Our monolithic application was becoming unmaintainable.
                The consulting engagement provided a clear migration strategy to
                microservices that minimized disruption while enabling our team
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                &quot;Our analytics queries were taking minutes to complete.
                After the database optimization engagement, the same queries now
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                ...
                that dramatically improved our code quality.&quot;
              </p>
              <div className="mt-4 flex items-center gap-2">
                <div className="font-medium">Results:</div>
                <div className="text-sm text-muted-foreground">
